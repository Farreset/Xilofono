        ...
        body: Center(
          child: Wrap( // coloca filas o columnas en función del espacio disponible
            ...
            children: [ // aqui se crean todos los hijos para despues passarlos
              ...
              buildButton(Colors.lightBlue, 'Sol', 'sounds/note4.wav'),
              buildButton(Colors.blueAccent, 'La', 'sounds/note5.wav'),
              buildButton(Colors.purple, 'Si', 'sounds/note6.wav'),
              buildButton(Colors.deepPurple, 'Do', 'sounds/note7.wav'),
            ],
          ),
        ),
      ),
